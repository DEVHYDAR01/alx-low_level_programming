...
/**
 * check_elf - This function will check if a file is an ELF file.
 * @e_ident: This is a pointer to an array containing the ELF magic numbers.
 *
 * Description: contains description if
...
/**
 * print_magic - This function will print the magic numbers of an ELF header.
 * @e_ident: This is a pointer to an
 * array containing the ELF magic numbers.
 *
 * Description: My description magic numbers are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int dex;
...
/**
 * print_data - This function is going to
...
/**
 * print_version - This function is going to
...
/**
 * print_type - This function will print the type of an ELF header.
...
/**
 * print_entry - This function will prints
